...
\hspace{12cm}\begin{minipage}{0.3\textwidth}
	\vspace{-11cm}
...
\begin{tabular}{|>{\raggedright}p{9cm}|P{1.1cm}|P{1.6cm}|P{2.4cm}|}
	...
	\hline
\BLOCK{for ue in ues}
\VAR{ue['libelle']} & \VAR{ue['moyenne']} & \VAR{ue['nbreCredits']} & 2017-2018\\
\hline
\BLOCK{endfor}

\multicolumn{2}{|l|}{\textbf{Total crédits obtenus}} & \textbf{\VAR{semestre.credits}} & \multicolumn{1}{c}{}\\\cline{1-3}
\end{tabular}
\end{center}
\vspace{1cm}
