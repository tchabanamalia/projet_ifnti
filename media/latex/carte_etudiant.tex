...
\multirow {8}{7cm}{\includegraphics[width=7cm]{etudianttemp.png}}
   		& N\degre étudiant : & \VAR{ etudiant.id } \\ 
...
\noindent
Année Academique {\color{blue} 2021-2022} \hspace{1cm} Niveau {\color{blue} \VAR{niveau}}\\
...
\noindent
\begin{tabular}{ccc}
Personne à prévenir : & \VAR{etudiant.personnePrevenir} & (\VAR{etudiant.contact})
\end{tabular}
